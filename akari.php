...
class Context
{
    ...
    public static function autoload($cls)
    {
        ...
        if (isset(self::$nsPaths[$nsPath[0]])) {
            $basePath = self::$nsPaths[array_shift($nsPath)];
...
spl_autoload_register(['Akari\Context', 'autoload']);
