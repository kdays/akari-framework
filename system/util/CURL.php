...
class CURL {
    ...
    public function __construct() {
        if(!function_exists("curl_init")){
            throw new AkariException("curl not installed");
        }
    }
     ...
     * @return CURLResponse {header, body, info}
     * @throws CURLException
     */
     ...
     * @param array $params 参数
     * @param array $opts
     * @return CURLResponse 结果数组中header为头部信息 info为curl的信息 body为空
     * @throws CURLException
     */
...
class CURLException extends AkariException {
    ...
    public function __construct($message, $code = NULL, $requestURL = "") {
        $this->message = "Remote Access Failed: " . $message;
        $this->code = $code;
